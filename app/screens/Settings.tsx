...
import {StyleSheet, ScrollView, View, Text, Switch, Image, Linking} from 'react-native';
      ...
      <ScrollView
        ...
        <Card style={{backgroundColor: theme.cardBg}}>
          <View style={styles.avatarRow}>
            ...
            <View>
              <Text style={{color: theme.color}}>Pino</Text>
              <Text style={{color: theme.color}}>Piano Tiles</Text>
            </View>
          </View>
          <>
            ...
            <MenuItem
              ...
              rightItem={
                <Switch
                  ...
                  thumbColor={theme.name === 'dark' ? '#FFA507' : '#f4f3f4'}
            ...
            <MenuItem
              ...
              onPress={() => Linking.openURL('https://growmoreapps.blogspot.com/2024/04/pin-piano.html')}
            />
